# Лабораторные работы по дисциплине "Защита информации" | Information security laboratory works
...
|:five:|[**Электронная подпись** (Digital signature)](https://github.com/architectv/information-security/tree/main/)|:orange_circle:|
